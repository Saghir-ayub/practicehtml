...
<!-- how to add sections based on user -->
<?php
     //open the if statement here:(deleterow)
     //if ($_SESSION['name']=='user'){
?>
     <!-- <div>input session specific stuff inbetween here</div> -->
<?php
     //close the if statement here(deleterow)
     //}
?>
